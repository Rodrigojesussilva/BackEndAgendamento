...
const VwAgendamentos = sequelize.define('VwAgendamentos', {
  agendamento_id: {
    type: DataTypes.INTEGER,
    primaryKey: true, // Define 'agendamento_id' como chave primária
  },
  dthoraagendamento: {
    type: DataTypes.DATE,
  },
  ...
  timestamps: false, // Views não têm timestamps
  freezeTableName: true, // Garante que o Sequelize não altere o nome da view
});
